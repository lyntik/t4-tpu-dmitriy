...
Fallback:
- основной путь плагина: denoise_volumeop.py
- если runtime хоста не исполняет этот entrypoint, C++ часть плагина может
  автоматически переключиться на filtration.py (при наличии hook-строки
  в Scripts/analytics/filtration.py, см. denoisewidget.cpp)
"""
import os
import sys
